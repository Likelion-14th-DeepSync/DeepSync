...
const CameraIcon = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
    <path d="M4 8.5a1.5 1.5 0 0 1 1.5-1.5H8l1.2-1.8A1.5 1.5 0 0 1 10.45 4.5h3.1a1.5 1.5 0 0 1 1.25.7L16 7h2.5A1.5 1.5 0 0 1 20 8.5v9a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 4 17.5v-9Z" stroke="currentColor" strokeWidth="1.7" strokeLinejoin="round" />
    <circle cx="12" cy="13" r="3.4" stroke="currentColor" strokeWidth="1.7" />
  </svg>
);
const ChatIcon = () => (
  <svg width="22" height="22" viewBox="0 0 24 24" fill="none">
    <path d="M4 12c0-4.4 3.8-8 8.5-8s8.5 3.6 8.5 8-3.8 8-8.5 8c-1 0-1.96-.15-2.85-.44L5 21l1.3-3.9C4.85 15.7 4 13.9 4 12Z" stroke="currentColor" strokeWidth="1.7" strokeLinejoin="round" />
  </svg>
);
const MoonIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
...
const SunIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
    ...
    <path d="M12 2.5v2.2M12 19.3v2.2M4.2 12H2M22 12h-2.2M5.3 5.3l1.5 1.5M17.2 17.2l1.5 1.5M18.7 5.3l-1.5 1.5M6.8 17.2l-1.5 1.5" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" />
  </svg>
);
const ChartIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
...
const SparkleIcon = () => (
  <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
    <path d="M12 3.5c.3 0 .57.2.65.49l.98 3.3a3.2 3.2 0 0 0 2.18 2.18l3.3.98a.68.68 0 0 1 0 1.3l-3.3.98a3.2 3.2 0 0 0-2.18 2.18l-.98 3.3a.68.68 0 0 1-1.3 0l-.98-3.3a3.2 3.2 0 0 0-2.18-2.18l-3.3-.98a.68.68 0 0 1 0-1.3l3.3-.98a3.2 3.2 0 0 0 2.18-2.18l.98-3.3c.08-.29.35-.49.65-.49Z" fill="currentColor" />
  </svg>
);
const MoreIcon = () => (
...
const ImagePickIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    ...
    <path d="M4 16.5l4.8-4.8a1.5 1.5 0 0 1 2.1 0l2.1 2.1M14 15l1.6-1.6a1.5 1.5 0 0 1 2.1 0L20.5 16" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
const CameraPickIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    <path d="M4 8.5a1.5 1.5 0 0 1 1.5-1.5H8l1.2-1.8A1.5 1.5 0 0 1 10.45 4.5h3.1a1.5 1.5 0 0 1 1.25.7L16 7h2.5A1.5 1.5 0 0 1 20 8.5v9a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 4 17.5v-9Z" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
    <circle cx="12" cy="13" r="3.2" stroke="currentColor" strokeWidth="1.6" />
  </svg>
);
const SendIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
    <path d="M12 19V6M6 11l6-6 6 6" stroke="white" strokeWidth="2.1" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
);
const SwitchCameraIcon = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    <path d="M4 8h3l1.5-2h7L17 8h3a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V9a1 1 0 0 1 1-1Z" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" />
    <path d="M9 12.2a3 3 0 0 1 4.8-1.3M15 11.8a3 3 0 0 1-4.8 1.3" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
    <path d="M13 9.5l1.2 1.3M11 14.5l-1.2-1.3" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round" />
  </svg>
);
...
const QUICK_QUESTIONS = [
  { key: "score", label: "왜 피부점수가 떨어졌어?", Icon: MoonIcon, tone: "moon" },
  { key: "routine", label: "오늘 루틴 추천해줘", Icon: SunIcon, tone: "sun" },
  { key: "week", label: "7일 실험 결과 알려줘", Icon: ChartIcon, tone: "chart" },
  { key: "dday", label: "D-Day 관리 어떻게 해?", Icon: CalendarIcon, tone: "calendar" },
  { key: "summary", label: "피부 변화 요약해줘", Icon: SparkleIcon, tone: "sparkle" },
];
...
/* -------------------------------------------------------------------- */
/*  Menu subview — greeting, feature cards, quick questions             */
/* -------------------------------------------------------------------- */
    ...
    <div className="ai-menu">
      ...
      <section className="ai-menu__actions">
        <button type="button" className="ai-card ai-card--action" onClick={onOpenCapture}>
          ...
          <span className="ai-card__chevron"><ChevronRight /></span>
        </button>
...
function AiChat({ onBack, initialQuestion }) {
  ...
  const sendMessage = (text) => {
    ...
    if (!trimmed) return;
    const userMsg = { id: nextId(), role: "user", text: trimmed, time: new Date() };
    setMessages((prev) => [...prev, userMsg]);
    setDraft("");
    setIsTyping(true);

    // Mocked "thinking" delay before the bot answers.
    // Replace this block with a real request to your AI backend.
    window.setTimeout(() => {
      const botMsg = { id: nextId(), role: "bot", text: getAiReply(trimmed), time: new Date() };
  ...
  return (
    <div className="ai-chat">
      ...
      <div className="ai-chat__body" ref={listRef}>
        ...
        {messages.length > 0 && <div className="ai-chat__date-divider"><span>오늘</span></div>}
        ...
        {messages.map((m) =>
          m.role === "user" ? (
            ...
            <div className="ai-chat__row ai-chat__row--bot" key={m.id}>
              <BotAvatar />
              <div className="ai-chat__col">
                <div className="ai-bubble ai-bubble--bot" style={{ whiteSpace: "pre-line" }}>
                  {m.text}
                </div>
      ...
      <form className="ai-chat__inputbar" onSubmit={handleSubmit}>
        <button type="button" className="ai-chat__icon-btn ai-chat__icon-btn--ghost" aria-label="이미지 첨부">
          <ImagePickIcon />
        </button>
        <button type="button" className="ai-chat__icon-btn ai-chat__icon-btn--ghost" aria-label="사진 촬영">
          <CameraPickIcon />
        </button>
        <input
        ...
        />
        <button type="submit" className="ai-chat__send" disabled={!draft.trim()} aria-label="보내기">
          <SendIcon />
        </button>
      </form>
    </div>
...
/* -------------------------------------------------------------------- */
/*  Capture subview — real device camera                                */
/* -------------------------------------------------------------------- */
...
function AiCapture({ onBack, onCapture }) {
  ...
  const [status, setStatus] = useState("requesting"); // requesting | ready | denied | unsupported | error
  ...
  return (
    <div className="ai-capture">
      <header className="ai-capture__header">
        <button type="button" className="ai-capture__icon-btn" onClick={onBack} aria-label="뒤로가기">
          <ChevronLeft />
        </button>
      ...
      <div className="ai-capture__stage">
        ...
        {capturedImage && <img src={capturedImage} alt="촬영된 피부 사진" className="ai-capture__preview" />}

        {!capturedImage && status === "ready" && (
          <svg className="ai-capture__guide" viewBox="0 0 400 520" fill="none">
            <ellipse cx="200" cy="245" rx="140" ry="200" stroke="rgba(255,255,255,0.85)" strokeWidth="2.5" strokeDasharray="7 8" />
            <line x1="40" y1="245" x2="80" y2="245" stroke="rgba(255,255,255,0.85)" strokeWidth="2" />
            <line x1="320" y1="245" x2="360" y2="245" stroke="rgba(255,255,255,0.85)" strokeWidth="2" />
            <line x1="200" y1="465" x2="200" y2="500" stroke="rgba(255,255,255,0.85)" strokeWidth="2" />
          </svg>
        )}
...
/* -------------------------------------------------------------------- */
/*  AI page — switches between menu / chat / capture                    */
/* -------------------------------------------------------------------- */

/**
 * AI
 * Route this at /ai (or wherever pages/Home, pages/Dday etc. are mounted).
 * Renders inside your existing MobileLayout, which already provides
 * BottomNav — this component does not render its own nav bar.
 *
 * Internally it swaps between three subviews with local state:
 *  - "menu"    : greeting + 피부 분석하기 / AI 상담 시작 cards + 빠른 질문
 *  - "chat"    : AI 상담 채팅 화면
 *  - "capture" : 실제 카메라 연동 피부 촬영 화면
 */
export default function AI() {
  const navigate = useNavigate();
  const location = useLocation();
  const [view, setView] = useState("menu"); // 'menu' | 'chat' | 'capture'
  ...
  const handleCapture = (photoDataUrl) => {
    ...
    // Hand the captured photo off to your skin-analysis flow here.
    setView("menu");
  };
