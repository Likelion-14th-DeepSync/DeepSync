...
public enum ErrorCode {
    ...
    REMINDER_SETTING_NOT_FOUND(HttpStatus.NOT_FOUND, "REMINDER_SETTING_NOT_FOUND", "리마인더 설정을 찾을 수 없습니다."),
    INVALID_REMINDER_TIMEZONE(HttpStatus.BAD_REQUEST, "INVALID_REMINDER_TIMEZONE", "올바른 IANA 타임존을 입력해 주세요."),
